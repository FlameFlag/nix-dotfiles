...
import (
	...
	"github.com/FlameFlag/nix-dotfiles/internal/immutableactivate/container"
	"github.com/FlameFlag/nix-dotfiles/internal/immutableactivate/flake"
	"github.com/FlameFlag/nix-dotfiles/internal/immutableactivate/host"
...
func (a app) activate() error {
	if a.options.RuntimePath != "" {
		...
		if err := os.Setenv(
			"PATH",
			a.options.RuntimePath+string(os.PathListSeparator)+oldPath,
		); err != nil {
			return err
		}
		defer func() {
