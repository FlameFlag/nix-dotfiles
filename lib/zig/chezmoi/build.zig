...
pub const import_name = "chezmoi";
pub const repo_root_source_file = "lib/zig/chezmoi/script.zig";
pub const local_root_source_file = "script.zig";
...
pub fn build(b: *std.Build) void {
    ...
    const test_step = b.step("test", "Run chezmoi Zig unit tests");
    ...
    addModuleTest(b, test_step, "test-chezmoi", module);
}
